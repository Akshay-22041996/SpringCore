...
import com.nt.FactoryMethod.PersonFactory;
...
public class FactoryPatternSOLUTIONTest {
	...
	public static void main(String[] args) {
		...
		/** PROBLEM CODE WITHOUT FACTORY PATTERN
		 * 
		 */
		/*
		 ...
		 * 
		 * Person per=new Employee("Raja", 24, details1,"HCL",45365.0, "Developer",
		 * "Munde");
		 * 
		...
		Person per=PersonFactory.getPerson("cust");
		System.out.println(per);
		System.out.println("**************************");
